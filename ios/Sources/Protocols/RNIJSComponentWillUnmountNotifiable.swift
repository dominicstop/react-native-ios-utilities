...
/// When a class implements this protocol, it means that it receives a
/// notification from JS-side whenever the component's `componentWillUnmount`
/// lifecycle is triggered.
///
